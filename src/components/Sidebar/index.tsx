    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 2.75C6.892 2.75 2.75 6.892 2.75 12C2.75 17.108 6.892 21.25 12 21.25C17.108 21.25 21.25 17.108 21.25 12C21.25 6.892 17.108 2.75 12 2.75ZM1.25 12C1.25 6.063 6.063 1.25 12 1.25C17.937 1.25 22.75 6.063 22.75 12C22.75 17.937 17.937 22.75 12 22.75C6.063 22.75 1.25 17.937 1.25 12Z"
              fill=""
            />
            <path
              d="M12 7.75C12.414 7.75 12.75 8.086 12.75 8.5V11.69L14.78 13.72C15.073 14.013 15.073 14.487 14.78 14.78C14.487 15.073 14.013 15.073 13.72 14.78L11.47 12.53C11.33 12.39 11.25 12.2 11.25 12V8.5C11.25 8.086 11.586 7.75 12 7.75Z"
              fill=""
            />
          </svg>
        ),
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/">
            {appLogo ? (
              <img src={appLogo as string} alt="Logo" className="max-h-8 w-auto object-contain" />
            ) : (
              <>
                <Image
                  width={176}
                  height={32}
                  src={"/images/logo/gyrlogo.png"}
                  alt="Logo"
                  priority
